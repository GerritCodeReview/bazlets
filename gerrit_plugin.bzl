...
def gerrit_plugin_tests(
    ...
    Args:
      ...
      plugin: Name of the plugin under test. Only required if `exports`,
        `ext_deps`, `ext_deps_label`, or automatic plugin target wiring is
        used. Only one of `ext_deps`, `ext_deps_label`, or `exports` is
        allowed.
      ext_deps: List of Maven coordinates for external test dependencies.
      ...
      ext_deps_label: Optional label of a java_library that exports external
        ...
        `gerrit_plugin_ext_test_deps()`. Only either `ext_deps`,
        `ext_deps_label`, or `exports` is allowed.
      ext_repo: Name of the external repository generated by rules_jvm_external.
        Defaults to `<plugin>_plugin_deps`.
      ...
      exports: List of targets to export for in-tree testing. Must be used together
        ...
        Only one of `ext_deps`, `ext_deps_label`, or `exports` is allowed.
    ...
    test_deps_attrs = [
        ...
        for attr, value in {
            "exports": exports,
            "ext_deps": ext_deps,
            "ext_deps_label": ext_deps_label,
        }.items()
        if value
    ]
    if len(test_deps_attrs) > 1:
        fail("Only one of `exports`, `ext_deps`, or `ext_deps_label` may be provided.")
    ...
    if ext_deps or ext_deps_label or exports:
        if not plugin:
