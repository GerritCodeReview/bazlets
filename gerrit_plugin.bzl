...
def gerrit_plugin_tests(
    ...
    Args:
      ...
      plugin: Name of the plugin under test. Only required if `ext_deps` or
        automatic plugin target wiring is used.
    ...
    if "exports" in kwargs:
        fail("gerrit_plugin_tests: `exports` is no longer supported; use `deps` or `ext_deps`")
