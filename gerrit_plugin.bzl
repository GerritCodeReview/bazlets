...
<<<<<<< PATCH SET (3fbaf3a3c0f2508df82bf483be8ba0cd3521aba0 Move generation of dependency tests to gerrit_plugin)
...
||||||| BASE      (0f43fe4a5cd7e7e7288daf8c3bc43bfcc9d8bf65 Add gerrit_plugin_ext_test_deps() macro)
def _expected_ext_deps_java_library_name(plugin):
    return plugin + "__plugin_test_deps"

=======
>>>>>>> BASE      (0854a750e54d398478b1a385a6df9b53dda05f53 gerrit_plugin_tests: stop implicitly creating Eclipse test d)
