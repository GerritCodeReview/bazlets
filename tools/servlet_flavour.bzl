...
value list, `gerrit_plugin`'s flavour validation, and the `flavour == "ee10"`
...
ServletFlavourInfo = provider(
    ...
    fields = {
        "flavour": "flavour name, e.g. \"ee8\" or \"ee10\"",
...
servlet_flavour_toolchain = rule(
    ...
    attrs = {
        "flavour": attr.string(mandatory = True, doc = "Flavour name, e.g. \"ee10\"."),
