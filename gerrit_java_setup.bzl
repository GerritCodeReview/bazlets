...
gerrit_java_setup is a rule for registering a Java toolchain with configuration
matching Gerrit core.
"""

def gerrit_java_setup(packages = []):
    [default_java_toolchain(
    ...
    # Error Prone errors enabled by default; see Gerrit core .bazelrc for how this
    # is enabled. This warnings list is originally based on:
